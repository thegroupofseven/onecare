<?php
/**
 * The template for displaying all single patient news posts
 *
 * @package WordPress
...
<style>.entry-content {display:block;}.entry-thumbnail img {display:none;} #subpage_content_container {margin-top:30px;}.navigation a, .job_salary, .job_url_title, .job_url, .job_application_date, .job_description, #download_job_description, #find_your_nearest_clinic {display:none;} </style>
	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div class="subpage-entry-title" style="background: url('/wp-content/uploads/2014/10/banner-background.png') #009dac; background-position: center; background-repeat: no-repeat;">
							<div class="subpage-entry-title-header" style="background:url('/wp-content/uploads/2015/04/header_information_for_patients.png');">
								<h2 class="single_post_subheader">	<?php
										$category = get_the_category(); 
										echo $category[0]->cat_name;
									?>
								</h2>
								<h1 style="line-height:1;max-width: 590px;"><?php the_title(); ?></h1>
