			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div id="subpage_content_container">
								...
								<div class="profile_container">
								  <div class="profile_picture">
									<?php $img=get_sub_field('profile_picture'); ?>
									  <img src="<?php echo $img['sizes']['large']; ?>" width="150" height="150" alt="<?php the_sub_field('name'); ?>" onError="this.src='/wp-content/uploads/2014/11/profile-picture-default.png';">
								  </div>
								  <div class="profile_information">
									<p class="profile_name"><strong><?php the_sub_field('name'); ?></strong></p>
						...
						<h2><?php the_field('programme_team_title'); ?></h2>

							<?php if(get_field('programme_team')): ?>
								<?php while(has_sub_field('programme_team')): ?>
								<div class="profile_container">
								  <div class="profile_picture">
									<?php $img=get_sub_field('profile_picture'); ?>
									<?php if( $img ): ?>
